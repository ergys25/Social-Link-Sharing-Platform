<script>
  ...
  <svelte:head>
    <title>Link-Vine - a place for links</title>
  ...
  <main class="flex w-full min-h-screen">
    ...
    <div class="hero bg-base-200">
      <div class="hero-content text-center">
        <div class="w-full">
          <h1 class="text-7xl font-bold">Link-Vine</h1>
          ...
          {:else}
            <a href="/login" class="btn btn-outline btn-secondary">Get Started</a>
            <a href="/fireship" class="btn btn-outline btn-secondary">Example Profile</a>
          {/if}
